...
class ScheduleOpenHousesScreen extends StatefulWidget {
  const ScheduleOpenHousesScreen({
    Key? key,
  }) : super(key: key);

  @override
  State<ScheduleOpenHousesScreen> createState() =>
      _ScheduleOpenHousesScreenState();
}

class _ScheduleOpenHousesScreenState extends State<ScheduleOpenHousesScreen> {
  ...
  _getPropertyList() async {
    try {
      ...
      final list = await NetworkService.getScheduleOpenProperties();
      propsList.clear();
