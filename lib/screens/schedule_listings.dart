...
class ScheduledListings extends StatefulWidget {
  const ScheduledListings({Key? key}) : super(key: key);

  @override
  State<ScheduledListings> createState() => _ScheduledListingsState();
}

class _ScheduledListingsState extends State<ScheduledListings> {
  ...
  _getPropertyList() async {
    try {
      ...
      final list = await NetworkService.getscheduledviewproperties();
      propsList.clear();
      // Logic for schedule listing, if today is not active start date
